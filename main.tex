...
\begin{frame}{Setting comparison on formulation \nPC}
    \begin{figure}
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models runtime]{\includegraphics[width=\linewidth]{inoc_runtime_nPC1.pdf}\label{fig:nPC1_runtime}{}}
        \end{minipage}
        \hfill
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models optimality gap]{\includegraphics[width=\linewidth]{inoc_gap_nPC1.pdf}\label{fig:nPC1_gap}{}}
        \end{minipage}
        \label{fig:nPC1}
        %\caption{Results of \nPC}\label{fig:x}
    \end{figure}
...
\begin{frame}{Setting comparison on formulation \nPCY}
    \begin{figure}
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models runtime]{\includegraphics[width=\linewidth]{inoc_runtime_nPC2.pdf}\label{fig:nPC2_runtime}{}}
        \end{minipage}
        \hfill
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models optimality gap]{\includegraphics[width=\linewidth]{inoc_gap_nPC2.pdf}\label{fig:nPC2_gap}{}}
        \end{minipage}
        \label{fig:nPC2}
        %\caption{Results of \nPC}\label{fig:x}
    \end{figure}
...
\begin{frame}{Setting comparison on formulation \nPCE}
    \begin{figure}
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models runtime]{\includegraphics[width=\linewidth]{inoc_runtime_nPC3.pdf}\label{fig:nPC3_runtime}{}}
        \end{minipage}
        \hfill
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models optimality gap]{\includegraphics[width=\linewidth]{inoc_gap_nPC3.pdf}\label{fig:nPC3_gap}{}}
        \end{minipage}
        \label{fig:nPC3}
        %\caption{Results of \nPC}\label{fig:x}
    \end{figure}
...
\begin{frame}{Formulation comparison on setting \sH}
    \begin{figure}
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models runtime]{\includegraphics[width=\linewidth]{inoc_runtime_PH.pdf}\label{fig:PH_runtime}{}}
        \end{minipage}
        \hfill
        \begin{minipage}[c]{.48\linewidth}
            \subfloat[models optimality gap]{\includegraphics[width=\linewidth]{inoc_gap_PH.pdf}\label{fig:PH_gap}{}}
        \end{minipage}
        \label{fig:PH}
        %\caption{Results of \nPC}\label{fig:x}
    \end{figure}
